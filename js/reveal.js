...
(function( root, factory ) {
	...
	function availableRoutes() {
		...
		if (rightSlide != -1) {
			if (horizontalSlides[rightSlide].getElementsByTagName("section").length) {
				childrenOfRightSlide = horizontalSlides[rightSlide].getElementsByTagName("section").length;				
			}
		} else {
			childrenOfRightSlide = 0;
		}

		if (leftSlide != -1) {
			if (horizontalSlides[leftSlide].getElementsByTagName("section").length) {
				childrenOfLeftSlide = horizontalSlides[leftSlide].getElementsByTagName("section").length;
			}
		} else {
